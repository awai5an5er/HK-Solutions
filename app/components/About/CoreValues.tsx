  ...
  return (
    <section className="w-[95%] mx-auto flex flex-col lg:gap-8 gap-5 justify-center items-center lg:py-10 py-5">
      ...
      <p className="text-txtColor normalText max-w-7xl text-justify">
        ...
        access trusted, government-backed energy solutions that are reliable,
        sustainable, and cost-effective. Our focus is on guiding clients toward
        approved programs that support long-term efficiency, reduced energy
